...
import { FileText, Users, Settings, Plus, DollarSign, Clock } from "lucide-react"
      ...
      <main className="p-6">
        <div className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground">Manage your invoices, companies, and settings</p>
          </div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">0</div>
                <p className="text-xs text-muted-foreground">No companies added</p>
              </CardContent>
            </Card>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure your default invoice information</CardDescription>
              </CardHeader>
              <CardContent>
                <Link href="/settings">
                  <Button variant="outline" className="w-full bg-transparent">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your latest invoices and updates</CardDescription>
            </CardHeader>
            <CardContent>
